        ...
        <div class="mt-12 flex flex-col items-center">
          ...
          <div class="w-full flex-1 mt-8">
            ...
            <div class="my-12 border-b text-center">
              ...
              >
                Отправили Вам письмо с подтверждением
              </div>
            </div>

            <div class="mx-auto max-w-xs">
              <p class="text-center text-gray-600">
                Если письмо не прибыло на адрес {{ $data['email'] }}, <br />
                <a href="{{route('login.create')}}" class="font-semibold text-indigo-600 hover:text-indigo-700">
